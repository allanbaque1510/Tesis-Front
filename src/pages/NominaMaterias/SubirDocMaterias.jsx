...
const SubirDocMaterias = () => {
    ...
    const registrarDatosExcel = () =>{
        dispatch(loadingOn())
        ExcelService.registrarDatosExcelNominaMateriaDocent({file:archivo})
        .then(response=>{
            dispatch(activarModalResult({
                success:true,
    ...
    return (
        <div>
            <h2>Documentos del reporte nomina carrera docentes materia   </h2>
            <Card>
...
export default SubirDocMaterias